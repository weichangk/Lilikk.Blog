using Blog.Admin.Application.Config.Dtos;
using Furion.ViewEngine;
using Microsoft.AspNetCore.Hosting;
using Microsoft.Extensions.Hosting;

namespace Blog.Admin.Application.Config;
...
public class CustomConfigService : BaseService<CustomConfig>, ITransient
{
    ...
    public async Task DeleteClass(KeyDto dto)
    {
        ...
        string path = Path.Combine(_environment.ContentRootPath.Replace(_environment.ApplicationName, ""), "Blog.Admin.Core/Config", $"{className}.cs");
...
namespace Blog.Admin.Core.Config;
...
";
        ...
        string path = Path.Combine(_environment.ContentRootPath.Replace(_environment.ApplicationName, ""), "Blog.Admin.Core/Config");
